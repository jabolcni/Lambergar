...
pub fn get_correction(search: *Search, pos: *Position) i32 {
    ...
    corr_eval += search.non_pawn_corr[pos.non_pawn_hash[0] % CORRHIST_SIZE][pos.side_to_play.toU4()][0] * 4;
    corr_eval += search.non_pawn_corr[pos.non_pawn_hash[1] % CORRHIST_SIZE][pos.side_to_play.toU4()][1] * 4;
