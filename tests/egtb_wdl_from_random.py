...
EXE_PATH = os.path.normpath(os.path.join(SCRIPT_DIR, "../zig-out/bin/lambergar"))
EPD_FILE = os.path.join(SCRIPT_DIR, "endgame_positions.epd")  # Your generated EPD file
SYZYGY_PATH = "/home/student/tuner/tables"
...
def main():
    with tee_output():
        ...
        while proc.poll() is None and (time.time() - start_time) < 5:
            ...
            if "tablebases initialized at:" in line.lower() or "tb_init succeeded" in line.lower():
                initialized = True
                break
